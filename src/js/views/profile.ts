// import { getProfile, getCurrentUserProfile } from "../services/profileService";
...
//         const response = await getPaginatedProfilePosts(username, 1, 5);
...
//             await getPaginatedProfilePosts(profile.name, page, 5),
